...
Usage examples:
    python scripts/extended_news_cleanup.py --base http://localhost:8081 --dry-run
    python scripts/extended_news_cleanup.py --base http://localhost:8081 --execute
...
def parse_args(argv: List[str]) -> argparse.Namespace:
    ...
    ap.add_argument("--base", default="http://localhost:8081", help="Base URL of the service (default: %(default)s)")
