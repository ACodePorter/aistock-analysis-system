                ...
                rows.map((r:any)=>{
                  ...
                  return (
                    <tr key={r.symbol}>
                      ...
                      <td style={{textAlign:'right', color: r.pct_change>0?'#16a34a': r.pct_change<0?'#dc2626':'#374151'}}>{r.pct_change!=null? r.pct_change.toFixed(2) : '-'}</td>
