-- ============================================================
-- 量化引擎（quant_engine）表结构迁移
-- 日期：2026-03-31
-- 说明：创建 qe_* 前缀的 9 张表，与现有业务表完全隔离
-- ============================================================

-- -----------------------------------------------------------
-- 1. qe_stock_models  每只股票的模型注册表
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- 6. qe_evaluation_runs  回测/评估运行记录
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- 7. qe_evaluation_metrics  评估指标明细
-- -----------------------------------------------------------
